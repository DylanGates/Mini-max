...
private struct ProjectRow: View {
    ...
    private var activityScore: Double {
        ...
        let recencyScore: Double = {
            guard gitStats.lastCommitTimestamp > 0 else { return 0 }
            let days = (Date().timeIntervalSince1970 - gitStats.lastCommitTimestamp) / 86400
            return max(0, 1.0 - days / 7.0) * 0.20
        }()
